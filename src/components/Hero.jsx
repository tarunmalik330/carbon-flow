  ...
  return (
    <div className="xl:min-h-screen min-h-[90vh] flex flex-col max-w-[1920px] mx-auto overflow-hidden relative">
      ...
      <div className="overflow-hidden">
        ...
        <div className="mt-[30px] lg:mt-0 max-lg:-mx-2 max-lg:translate-y-1 hero-img-clipPath lg:absolute -right-24 w-full max-w-[700px] xl:max-w-[846px] z-0 bottom-0 xl:-bottom-0">
